    ...
    <div class="container">
        ...
        <div class="row shadow-md">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6  ">
                ...
                <h1 class=" text-blue-900 font-bold text-3xl mt-2 ">{{ $Post->title }}</h1>
                <ul class="list-inline mt-4">
                    <li>Date | {{ $Post->created_at }}</li>
                </ul>
                <p class="lead mt-10">{{ $Post->description }}</p>
                @auth
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <div class="input-group">
                                <span class="input-group-btn">
                                    ...
                                    {{-- @else --}}
                                        <a class=" bg-red-600 p-2 rounded-lg text-gray-50 " type="button" id="increaseButton" href="{{ route('Posts@vote', $Post->id) }}"
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <div class="input-group">
                                <span class="input-group-btn">
                                        ...
                                        <a class=" bg-blue-700 p-2 rounded-lg text-gray-50" type="button" id="decreaseButton" href="{{ route('Posts@unvote', $Post->id) }}"
                                            class="btn btn-danger">
                                            <i class="fas fa-chevron-down"></i>
                                        </a>
